function assertCondition(condition: any, message: string | undefined = "", prefix: string | undefined = ""): asserts condition {
  if (!condition) {
 ...
 */
export function assert(condition: any, message?: string, prefix: string | undefined = "[assert] "): asserts condition {
 ...
 */
export function invariant(condition: any, message?: string, prefix: string | undefined = "[invariant] "): asserts condition {
  assertCondition(condition, message, prefix)
}